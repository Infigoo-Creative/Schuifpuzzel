...
export const FINISH_LINES = {
  ...
  normal: [
    ...
    '🖱️ Je muis heeft overuren gedraaid.',
    ...
    '🏋️ Dit was officieel een schuifsessie.',
    '👀 De finish zag je al aankomen.',
    '🤐 Niet vloeken tegen de tegels hè.',
    '🏳️ Deze puzzel geeft zich gewonnen.',
    '🧈 Dat zag er soepeltjes uit.',
    '⚔️ Je hebt de chaos weer verslagen.',
    '🏠 De tegels mogen weer naar huis.',
    '💰 Eén puzzel rijker.',
    '😅 Zelfs de puzzel moest even bijkomen.',
    '⚙️ De schuifmotor draait op volle toeren.',
    '🛠️ Je bent officieel weer iets handiger.',
    '😉 Nog eentje dan?',
  ],
};
